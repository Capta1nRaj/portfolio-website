...
export default function HamburgerMenuIconAnimated() {
    ...
    return (
        <>
            <div
                className="flex fixed top-4 right-4 flex-col rounded justify-center items-center group cursor-pointer z-10"
            ...
            <div className={`flex flex-col items-center fixed top-0 ${showMenu} bottom-0 justify-evenly bg-[#111111] px-16 ${transition}`} onClick={enableDisableHamburgerMenu}>
                {contents}
            </div>
        </>
    )
