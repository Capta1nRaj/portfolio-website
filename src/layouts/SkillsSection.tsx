...
const SkillsSection = () => {
    return (
        <div className="skills-section-layout sm:py-20 py-10 bg-black text-white" id='skills'>
            <div className="max-width">
                <Headings title="What I Build With" subHeading="Modern stack for fast, reliable deliverables" />
